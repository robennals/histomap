...
const Visualization = (function() {
    ...
    const GDP_BLOC_COLORS = {
        ...
        'BRICS': '#d68910',                      // Dark orange (modern emerging bloc)
        ...
        'Russia': '#e84393',                     // Pink (Russian Empire through modern Russia)
        'Japan': '#27ae60',                      // Green (distinct from orange India)
        ...
        // Ancient empires (for British/World History pre-1750)
        ...
        // Very ancient civilizations (for World History)
        'Mesopotamia': '#8b4513',                // Saddle brown (fertile crescent, earth tones)
        'Egypt': '#daa520',                      // Goldenrod (pyramids, desert gold)
        'Greeks': '#4169e1',                     // Royal blue (classical)
        'Persian Empire': '#800020',             // Burgundy (distinct from others)
        'Carthage': '#dc143c'                    // Crimson (Phoenician, Mediterranean)
    };
